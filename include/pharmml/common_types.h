...
typedef enum {
    ...
    PHARMML_INDIV_PARAMETER, PHARMML_POP_PARAMETER, PHARMML_RAND_EFFECT, PHARMML_RESIDUAL, PHARMML_STAT_PRECISION, PHARMML_STRATA_VARIABLE,
    PHARMML_STRUCT_PARAMETER, PHARMML_VAR_PARAMETER_VAR, PHARMML_VAR_PARAMETER_STDEV, PHARMML_VAR_PARAMETER_COV, PHARMML_VAR_PARAMETER_CORR
} pharmml_columnType;
